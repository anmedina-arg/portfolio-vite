          ...
          <div className="homeLayout">
            ...
            <div className="contentHome">
              <div className="contentTextHome">
                ...
                <div className="inlineText">
                  <Paragraph>
                    Desarrollo <b>aplicaciones y sitios web</b> que transforman tus ideas en
                    realidades digitales, <b>fusionando arte y tecnología</b>, con una{' '}
                    <b>belleza estética</b> y una <b>funcionalidad sólida y robusta</b>.
                  </Paragraph>
                </div>
